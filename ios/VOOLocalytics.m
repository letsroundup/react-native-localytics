...
RCT_EXPORT_METHOD(tagSearched:(NSDictionary*)params)
{
  ...
  [Localytics tagSearched:searchText contentType:contentType resultCount:resultCount attributes:attributes];
}
...
RCT_EXPORT_METHOD(tagInvited:(NSDictionary*)params)
{
  ...
  [Localytics tagInvited:method attributes:attributes];
}
